...
local config = require("klaoude.features.lualine.config")
...
function M._load()
	...
	local theme = require("klaoude.features.lualine.theme")(config)
	local _ = require("klaoude.features.lualine.palette")(config)
	local cpn = require("klaoude.features.lualine.components")
	-- palette.setup()
