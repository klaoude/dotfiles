...
---@class Util
---@field root klaoude.utils.root
---@field telescope klaoude.utils.telescope
---@field theme klaoude.utils.theme
---@field plugin klaoude.utils.plugin
---@field lualine klaoude.utils.lualine
---@field cmd klaoude.utils.cmd
---@field lsp klaoude.utils.lsp
---@field string klaoude.utils.string
---@field table klaoude.utils.table
---@field ui klaoude.utils.ui
---@field cmp klaoude.utils.cmp
local M = {}

setmetatable(M, {
	__index = function(_, k)
		local mod = require("klaoude.utils." .. k)
		return mod
	end,
})
